...
const iosAppId = "6746817742"; // Placeholder - replace with actual App ID
const androidAppId = "com.babble.translator"; // From app.json
const STORE_URLS = {
...
// Deep link scheme for translator app
const TRANSLATOR_SCHEME = "myapp://";
...
function TranslatorPage() {
  ...
  useEffect(() => {
    const initialAttempt = () => {
      ...
      // Build deep link URL with query parameters if any
      let linkUrl = TRANSLATOR_SCHEME;
      const queryString = searchParams.toString();
      if (queryString) {
        linkUrl += (linkUrl.endsWith("://") ? "" : "/") + "?" + queryString;
      }
